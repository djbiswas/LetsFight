    ...
    <div class="container pb-cmnt-container">
        ...
        <div class="row mt-5">
            <div class="embed-responsive embed-responsive-16by9 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLEjiSCBun3a4e-wqQxwSg9-HLJTjj5gRn" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
