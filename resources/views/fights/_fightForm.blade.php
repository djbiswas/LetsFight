...
<div class="row">
    <div class="col">
        ...
        <div class="form-group  ">
            ...
            {{Form::select('player_1', [], null, ['class' => 'form-control select2op','id' => 'player_1', 'placeholder' => '--- Select Player 1 ---', 'required']) }}
    ...
    <div class="col">
        ...
        <div class="form-group  ">
            ...
            {{Form::select('player_2', [], null, ['class' => 'form-control select2op','id' => 'player_2', 'placeholder' => '--- Select Player 2 ---.', 'required']) }}
